...
class ContactAndSocials extends React.Component<IProps, IState> {
    ...
    render() { 
        ...
        <div className="contact-and-socials">
            ...
            <SocialInfo buttonText='Go to Soundcloud' link='https://soundcloud.com/user-50479978' name='' icon={soundCloundIcon}></SocialInfo>
            <SocialInfo buttonText='Go to Twitter' link='https://twitter.com/TriangularStud1' name='Twitter' icon={twitterIcon}></SocialInfo>
            <SocialInfo buttonText='Send a mail' link='mailto:randomowyrandom21@gmail.com' name='E-mail' icon={emailIcon}></SocialInfo>
        </div> 
        );
    }
}
